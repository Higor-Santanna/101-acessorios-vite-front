    ...
    return (
        <>
            ...
            <div>
                ...
                <div>
                    <p className="mb-5 mx-40 text-base text-black font-medium max-md:mx-5">- Não deve estar trincado, arranhado e nem com outras marcas de mal-uso;</p>
                    <p className="mb-5 mx-40 text-base text-black font-medium max-md:mx-5"> - Deve ter todos os acessórios originais e os manuais em bom estado.</p>
                    <p className="mb-5 mx-40 text-base text-black font-medium max-md:mx-5">- A caixa/saco do produto está inteira e sem rasgos.</p>
                </div>
            </div>
        </>
    )
